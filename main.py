...
# ヘルプコマンド
@bot.tree.command(name="help", description="ヘルプメッセージを表示します")
async def help_command(interaction: discord.Interaction):
    help_message = (
        "利用可能なコマンド:\n"
        "/add_gban [ユーザー]: グローバルBANするユーザーを追加\n"
        "/gbanlist: グローバルBANされたユーザーのリストを表示\n"
        "/setblock [招待リンクの検出: True/False] [暴言の検出: True/False]: 各機能の有効/無効を設定\n"
        "/support: サポートサーバーの招待リンクをDMで送信\n"
        "/help: このヘルプメッセージを表示\n"
    )
